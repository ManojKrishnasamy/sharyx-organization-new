...
export class CountryService {
  ...
  async Insert(CountryData: CountryModel, UserId: string,UserIp: string) {
    ...
    this._AuditLogService.AuditEmitEvent({ PerformedType: country.name, ActionType: LogActionEnum.Insert, PrimaryId: [_CountryData.id],UserIp: UserIp });
  ...
  async Update(Id: string, CountryData: CountryModel, UserId: string,UserIp: string) {
    ...
    this._AuditLogService.AuditEmitEvent({ PerformedType: country.name, ActionType: LogActionEnum.Update, PrimaryId: [CompanyUpdateData.id] ,UserIp: UserIp});
  ...
  async Delete(Id: string,UserIp: string) {
    ...
    this._AuditLogService.AuditEmitEvent({ PerformedType: country.name, ActionType: LogActionEnum.Delete, PrimaryId: [Id],UserIp: UserIp });
