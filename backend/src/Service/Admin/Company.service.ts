...
export class CompanyService {
  ...
  async Update(Id: string, CompanyData: CompanyModel, UserId: string,UserIp: string) {
    ...
    this._AuditLogService.AuditEmitEvent({ PerformedType: company.name, ActionType: LogActionEnum.Update, PrimaryId: [CompanyUpdateData.id],UserIp: UserIp });
  ...
  async Insert(CompanyData: CompanyModel, UserId: string,UserIp: string) {
    ...
    this._AuditLogService.AuditEmitEvent({ PerformedType: company.name, ActionType: LogActionEnum.Insert, PrimaryId: [_CompanyData.id],UserIp: UserIp });
